...
public class Problem17478 {
    static StringBuilder recursive(int original, int n, StringBuilder sb){
        String prefix = "____".repeat(original - n);
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(recursive(num, num, sb));
